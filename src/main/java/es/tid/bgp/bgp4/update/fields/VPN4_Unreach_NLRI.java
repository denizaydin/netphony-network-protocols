...
public  class VPN4_Unreach_NLRI extends NLRI {
	/**
	...
	public VPN4_Unreach_NLRI(){
		super();
		this.label=8388608; // must be zero, reserved
		this.rdType=0;
	...
	public VPN4_Unreach_NLRI(byte []bytes, int offset) {
		...
		while (bottomOfLabelStack==0) {
			...
			{
				bottomOfLabelStack = 1; //reserved labels it should be fixed to one label and value 8388608
			}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VPN4_Unreach_NLRI other = (VPN4_Unreach_NLRI) obj;
